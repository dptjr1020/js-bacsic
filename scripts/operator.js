...
//'안녕'+'봄' 문자열 2개를 연결
//= 우측의 값을 좌측 변수로 대입
console.log(greeting+'잘가'); //'잘가' 일회성
//console.log() 객체.함수()
...
//log(), typeof()
//prompt() 질문, 답변 창을 띄우는 함수(문자열로 식)
//Number()
//괄호 안의 데이터를 숫자로 변환하는 함수
//1+4=?
//유치원생 대상 두 수를 더하는 문제 프로그래밍
const num1 = Number(prompt('첫 번째 수를 입력하세요'));
//1. const num1 상수 생성
//2. prompt() 질문하고 사용자에게 문자열 답변 받고
//3. Number() 문자열을 숫자로 변환
//4. = 대입연산자로 num1에 대입완료
const num2 = Number(prompt('두 번째 수를 입력하세요'));
//console.log(num1, typeof(num1));1
//결과 담는 변수
