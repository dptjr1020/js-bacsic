const filterView = document.querySelector('.filter .filter_view')
...
for (let f of filterA){// 필터 보기 메뉴
    ...
    f.addEventListener('click',function(e){
        e.preventDefault();
        console.log('클릭퇸 a :', f);//필터보기메뉴 클릭 시 인식해야하는 상품 목록들
        for(let list of filterContents){
            console.log(list);
            //클릭한 f가 전체보기면 -> list 전체보이기
            ...
            //클릭한 f가 채소이면 -> data-name="veggi"와 일치하는 list 찾아서 보이기
