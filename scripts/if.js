...
data3 = null; //null 값을 삭제할 때 대입하는 키워드
console.log(data3);
...
let x = 10;
let y = 20;
let result = x != y; //=(대입) ==(피연산자가 같은지 비교연산자) != (다른가)

console.log(`result => ${result}`)
if(result) console.log('result는 참'); // 실행이 한 줄이면 중괄호 생략 가능
